...
# =============================================================================
# z_09_setup_classification_ai_ml.sh
# Implements AI/ML classifier using Amazon Bedrock
# =============================================================================

set -e  # Exit on error

echo "=========================================="
echo "Step 9: Implementing AI/ML Classifier"
echo "=========================================="
...
AI_ML_PATH="$APP_PATH/ai_ml"

echo "AI/ML path: $AI_ML_PATH"

# =============================================================================
# Create ai_ml/interfaces/classifier.py
# =============================================================================
echo "Creating ai_ml/interfaces/classifier.py..."
cat > "$AI_ML_PATH/interfaces/classifier.py" << 'EOF'
...
echo "Created interfaces/classifier.py"

# =============================================================================
# Create ai_ml/implementations/bedrock_classifier.py
# =============================================================================
echo "Creating ai_ml/implementations/bedrock_classifier.py..."
cat > "$AI_ML_PATH/implementations/bedrock_classifier.py" << 'EOF'
import os
import json
import base64
import boto3
...
echo "Created implementations/bedrock_classifier.py"

# =============================================================================
# Create ai_ml/implementations/__init__.py with exports
# =============================================================================
echo "Updating ai_ml/implementations/__init__.py..."
cat > "$AI_ML_PATH/implementations/__init__.py" << 'EOF'
...
# =============================================================================
# Create ai_ml/interfaces/__init__.py with exports
# =============================================================================
echo "Updating ai_ml/interfaces/__init__.py..."
cat > "$AI_ML_PATH/interfaces/__init__.py" << 'EOF'
from .classifier import IClassifier, ClassificationInput, ClassificationOutput

__all__ = ['IClassifier', 'ClassificationInput', 'ClassificationOutput']
EOF

# =============================================================================
# Create ai_ml/__init__.py with exports
# =============================================================================
echo "Updating ai_ml/__init__.py..."
cat > "$AI_ML_PATH/__init__.py" << 'EOF'
from .interfaces import IClassifier, ClassificationInput, ClassificationOutput
from .implementations import BedrockClassifier
...
echo ""
echo "=========================================="
echo "AI/ML Classifier implemented!"
echo "=========================================="
echo ""
echo "Files created:"
echo "  - ai_ml/interfaces/classifier.py (interface + dataclasses)"
echo "  - ai_ml/implementations/bedrock_classifier.py (Bedrock Claude)"
echo ""
echo "Usage:"
echo "  from document_classification.ai_ml import BedrockClassifier, ClassificationInput"
echo ""
echo "  classifier = BedrockClassifier()"
echo "  result = classifier.classify(ClassificationInput("
echo "      s3_bucket='my-bucket',"
echo "      s3_key='docs/license.pdf',"
echo "      filename='license.pdf',"
echo "      application_id='app-001'"
echo "  ))"
echo ""
echo "Next step:"
echo "  ./setup-scripts/z_10_setup_classification_api.sh"
echo ""